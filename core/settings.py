...
SECRET_KEY = "django-insecure-d=vkz10=c2jr%j8y_-&e@2xm0n79(9gihp2!ftc@xs4*gpi^(o"
...
DATABASES = {
    'default': {
        'ENGINE': 'django.contrib.gis.db.backends.postgis', # Dùng backend GIS
        'NAME': 'car_rental_gis',
        'USER': 'postgres',
        'PASSWORD': '123',
        'HOST': 'localhost',
...
EMAIL_HOST_PORT = 587 
EMAIL_HOST_USER = 'e3d76e69541f89'
...
# Thêm bin vào đầu PATH để Windows tìm thấy các file .dll ngay lập tức
...
# Sử dụng chuỗi thô (r'') để tránh lỗi dấu cách và tiếng Việt trong đường dẫn
